    ...
    public static ArrayList<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                //Extract the value associated with the key 'webTitle'
                String webTitle = currentNews.getString("webTitle");

                //Extract the value associated with the key 'sectionName'
                String sectionName = currentNews.getString("sectionName");

                //Extract the value associated with the key 'webPublicationDate'
                String webPublicationDate = currentNews.getString("webPublicationDate");
                webPublicationDate = webPublicationDate.substring(0, 10);

                //Extract the value associated with the key 'webUrl'
                String webUrl = currentNews.getString("webUrl");

                // Create a new {@link News} object with the
